...
export const SystemPrompt: FC<Props> = ({ conversation, prompts, onChangePrompt }) => {
  ...
  return (
    <div className="flex flex-col p-20">
      <label className="text-neutral-700 dark:text-neutral-400 mb-2 text-left">{'System Prompt'}</label>
      <textarea
        ref={textareaRef}
        className="border-neutral-200 text-neutral-900 dark:border-neutral-600 dark:text-neutral-100 w-full rounded-lg border bg-transparent px-15 py-10"
        style={{
          resize: 'none',
