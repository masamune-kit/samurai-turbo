      ...
      <div className="relative flex items-center text-secondary">
        {isRenaming ? (
          <div className="flex w-full items-center gap-3 bg-white p-3">
            ...
            <input
              className="border-neutral-400 focus:border-neutral-100 mr-12 flex-1 overflow-hidden overflow-ellipsis bg-transparent text-left text-[14px] leading-3 text-white outline-none"
              type="text"
              value={renameValue}
          ...
          <button
            className={`text-sm flex w-full cursor-pointer items-center gap-3 rounded-lg p-10 transition-colors duration-200 hover:bg-white-darker`}
          ...
          >
            ...
            <div className="relative max-h-15 flex-1 overflow-hidden text-ellipsis whitespace-nowrap break-all text-left text-[14px] leading-3">
              {currentFolder.name}
            </div>
          </button>
        )}
